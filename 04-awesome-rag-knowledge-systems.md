...
|---|---|---|---|---|---|---|
| 2026-08 | KDD 2026 | Mixture-of-RAG: Integrating Text and Tables with Large Language Models | [paper](https://doi.org/10.1145/3770854.3780171) | - | ★★★★☆ | Integrates table and text retrieval rather than flattening both into one representation. |
| 2026-08 | KDD 2026 | VideoRAG: Retrieval-Augmented Generation with Extreme Long-Context Videos | [paper](https://doi.org/10.1145/3770854.3783944) | - | ★★★★☆ | Builds retrieval and generation around videos too long to place directly in model context. |
| 2026-08 | arXiv | Retrieval Needs Multivectors: An Exponential Separation | [paper](https://arxiv.org/abs/2608.21494) | - | ★★★★☆ | Gives theoretical and empirical evidence for retaining multiple vectors per document. |
...
| Date | Venue | Title | Paper | Code | Rec | Comment |
|---|---|---|---|---|---|---|
| 2026-08 | KDD 2026 | CREAM: Continual Retrieval on Dynamic Streaming Corpora with Adaptive Soft Memory | [paper](https://doi.org/10.1145/3770854.3780281) | - | ★★★★☆ | Maintains retrieval quality as a corpus changes by adapting a compact soft memory. |
| 2026-08 | KDD 2026 | BRIDGE: Block-Wise Speculative Coordination for Cloud-Edge Retrieval-Augmented Generation | [paper](https://doi.org/10.1145/3770855.3818064) | - | ★★★★☆ | Speculatively coordinates retrieval and generation blocks across edge and cloud. |
| 2026-08 | arXiv | RAG-Stack: Co-Optimizing RAG Serving Performance and Quality | [paper](https://arxiv.org/abs/2608.03487) | - | ★★★★☆ | Searches retrieval, index, and model configurations jointly under quality and latency goals. |
| 2026-08 | CoDIT 2026 | SAGE: SLO-Aware Adaptive Retrieval for Production RAG Systems | [paper](https://arxiv.org/abs/2608.08237) | - | ★★★☆☆ | Chooses per-query retrieval depth under tail-latency and infrastructure-cost constraints. |
...
| Date | Venue | Title | Paper | Code | Rec | Comment |
|---|---|---|---|---|---|---|
| 2026-09 | VLDB 2026 | QA-GraphRAG: Query-Adaptive Plug-and-Play Retrieval Integration for Graph-based Retrieval-Augmented Generation | [paper](https://www.vldb.org/pvldb/vol19/p2224-sheng.pdf) | - | ★★★★☆ | Selects graph-retrieval components per query through a plug-and-play integration layer. |
| 2026-09 | VLDB 2026 | BookRAG: A Hierarchical Structure-aware Index-based Approach for Retrieval-Augmented Generation on Complex Documents | [paper](https://www.vldb.org/pvldb/vol19/p2358-wang.pdf) | - | ★★★★☆ | Indexes document hierarchy to retrieve evidence from book-length structured material. |
| 2026-09 | VLDB 2026 | MGRAG: Semantic Subgraph Matching and Graph-Aware Caching for Multimodal Retrieval-Augmented Generation | [paper](https://www.vldb.org/pvldb/vol19/p2480-wang.pdf) | - | ★★★★☆ | Couples multimodal subgraph matching with graph-aware reuse. |
| 2026-09 | VLDB 2026 | GraphContainer: A Unified Platform for Comparing and Debugging Graph RAG Methods | [paper](https://www.vldb.org/pvldb/vol19/p4550-an.pdf) | - | ★★★☆☆ | Standardizes GraphRAG execution and exposes intermediate state for method debugging. |
| 2026-08 | KDD 2026 | Accelerating Graph-Based RAG Retrieval via Locality-Aware Device-Cloud Collaboration | [paper](https://doi.org/10.1145/3770855.3817674) | - | ★★★★☆ | Partitions graph retrieval across device and cloud according to locality. |
| 2026-08 | KDD 2026 | NaviRAG: Learning to Navigate Knowledge Graphs for Retrieval-Augmented Generation | [paper](https://doi.org/10.1145/3770855.3817935) | - | ★★★★☆ | Learns graph navigation policies for multi-hop evidence retrieval. |
| 2026-08 | KDD 2026 | Structure Is All You Need to Reuse: Accelerating GraphRAG via Meta-Structure-Aware KV Caching | [paper](https://doi.org/10.1145/3770855.3817942) | - | ★★★★☆ | Reuses KV state across recurring GraphRAG meta-structures. |
| 2026-08 | KDD 2026 | Core-based Hierarchies for Efficient GraphRAG | [paper](https://doi.org/10.1145/3770855.3818007) | - | ★★★☆☆ | Uses graph cores to build compact retrieval hierarchies. |
| 2026-08 | KDD 2026 | MemGraphRAG: Memory-based Multi-Agent System for Graph Retrieval-Augmented Generation | [paper](https://doi.org/10.1145/3770855.3818074) | - | ★★★★☆ | Adds shared memory and specialized agents to graph retrieval and reasoning. |
| 2026-08 | arXiv | KGCache: Amortized Subgraph Retrieval for KG Reasoning with LLMs | [paper](https://arxiv.org/abs/2608.07954) | - | ★★★☆☆ | Caches repeatedly accessed one-hop neighborhoods across knowledge-graph queries. |
| 2026-07 | arXiv | GLM-RAG: Graph Language Models for Graph-Based Retrieval-Augmented Generation | [paper](https://arxiv.org/abs/2607.28397) | - | ★★★☆☆ | Uses graph language models to combine topology and semantics in the retriever. |
...
| Date | Venue | Title | Paper | Code | Rec | Comment |
|---|---|---|---|---|---|---|
| 2026-08 | KDD 2026 | RARE: Retrieval-Augmented Reasoning Modeling | [paper](https://doi.org/10.1145/3770855.3817899) | - | ★★★★☆ | Trains retrieval and reasoning as one model rather than a fixed external pipeline. |
| 2026-07 | arXiv | Baikal: Structured Search for Deep Research over Data Lakes | [paper](https://arxiv.org/abs/2607.27726) | - | ★★★★☆ | Treats deep research over heterogeneous data lakes as budgeted structured search. |
| 2026-07 | arXiv | BM25 Wins at Scale: A Scaling Study of Retrieval-Augmented Generation Paradigms | [paper](https://arxiv.org/abs/2607.26497) | - | ★★★★☆ | Compares lexical, dense, graph, and agentic retrieval over a controlled 450-fold corpus scale-up. |
...
| Date | Venue | Title | Paper | Code | Rec | Comment |
|---|---|---|---|---|---|---|
| 2026-09 | VLDB 2026 | RAGPerf: An End-to-End Benchmarking Framework for Retrieval-Augmented Generation Systems | [paper](https://www.vldb.org/pvldb/vol19/p3689-li.pdf) | - | ★★★★☆ | Measures retrieval, generation, quality, and systems performance end to end. |
| 2026-08 | KDD 2026 | RAViG-Bench: A Benchmark for Retrieval-Augmented Visually-Rich Generation with Multi-Modal Automated Evaluation | [paper](https://doi.org/10.1145/3770855.3817479) | - | ★★★☆☆ | Evaluates retrieval-grounded generation of visually rich multimodal outputs. |
| 2026-08 | KDD 2026 | How Much Reasoning Do Retrieval-Augmented Models Add beyond LLMs? A Benchmarking Framework for Multi-Hop Inference over Hybrid Knowledge | [paper](https://doi.org/10.1145/3770855.3817481) | - | ★★★★☆ | Separates gains from retrieval, base-model knowledge, and true multi-hop reasoning. |
| 2026-08 | KDD 2026 | CRAG-MM: Multi-modal Multi-turn Comprehensive RAG Benchmark | [paper](https://doi.org/10.1145/3770855.3817544) | - | ★★★★☆ | Evaluates realistic multimodal RAG across multiple conversational turns. |
| 2026-08 | KDD 2026 | MKG-RAG-Bench: Benchmarking Retrieval in Multimodal Knowledge Graph–Augmented Generation | [paper](https://doi.org/10.1145/3770855.3817570) | - | ★★★☆☆ | Isolates retrieval quality in multimodal knowledge-graph RAG. |
...
| 2026-08 | KDD 2026 | RAG vs. GraphRAG: A Systematic Evaluation and Key Insights | [paper](https://doi.org/10.1145/3770855.3817575) | - | ★★★★☆ | Systematic comparison of vector RAG and GraphRAG across tasks and corpus structures. |
